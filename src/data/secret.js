...
export const secretDate = {
  ...
  finale: [
    ...
    "Não estamos há {tempo} nos conhecendo. Conhecer implica optar: gosto ou não gosto. Prefiro dizer que estamos construindo em todos esses dias. Construir aceita a realidade e acolhe a imperfeição humana. Dia após dia. Nos dias em que gostamos mais, nos dias em que gostamos menos.",
...
export const officialDate = {
  ...
  story: [
    ...
    "20 de junho é um dos dias mais importantes da nossa história, que marca um novo início da construção da nossa história, uma paz de termos nos escolhido para construir um relacionamento lindo juntos, cheio de muito amor, carinho, compartilhamento, risadas, estudos, choros, bobeirinhas, comida boa, vida saudável, tudo que queremos e merecemos dividir. Que alegria é te escolher daqui pra frente. Te amo, Sophia Valerio ❤️",
  ],
};
