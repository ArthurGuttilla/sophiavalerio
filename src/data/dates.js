...
export const dates = [
  ...
  },
  {
    ...
    story: [
      "Um dia especial. Te busquei em casa, pegamos o carro e fomos para a Granja (e quase bateram no meu carro, rs). Como sempre, mais de uma hora de estrada passou voando.",
      "Confesso que eu estava nervoso. Sei o quanto a Ju é uma amizade importante para você. Não queria estar cansado, não queria parecer chato, não queria errar. E me senti tão bem podendo ser eu mesmo com as meninas, parecia que eram do meu próprio grupo de amigos. E não é que a Mari estava por perto?",
      ...
      "Mas melhorou: a nossa volta. Eu não queria chegar na sua casa. Dirigi o caminho inteiro com uma mão só no volante e a outra segurando a sua. E você segurando o meu braço, fazendo carinho, deitando, apertando como quem não quer largar. Foi menos conversa do que a gente costuma ter, porque foi uma noite de mais sentimento: de pensar no que estava acontecendo, de refletir, de curtir a nossa presença, um com o outro. Acho que as letras românticas e um belo acordeon de Dominguinhos ajudaram no clima.",
      "Ao chegar, uma conversa delicada e sensível, você abrindo o coração sobre o que tinha acontecido. Foi a primeira vez que senti uma dor junto com você. Terminamos com um abraço apertado, amoroso, que podia ser infinito.",
